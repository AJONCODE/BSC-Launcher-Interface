...
import { ETHER, JSBI/** , TokenAmount*/ } from 'bsc-testnet-dex-sdk'
  ...
  return (
    ...
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/BNB/${currencyId(currency0)}/${currencyId(currency1)}/${stakingInfo.index}`} style={{ width: '100%' }}>
      ...
      <StatContainer>
        ...
        <RowBetween>
          ...
          <TYPE.white>{`${stakingInfo.totalRewardRate
            ?.multiply(`${60 * 60 * 24}`)
            ?.toFixed(0, { groupSeparator: ',' })} BNB / day`}</TYPE.white>
        </RowBetween>
        <RowBetween>
          ...
          <BottomSection showBackground={true}>
            ...
            <TYPE.black style={{ textAlign: 'right' }} color={'white'} fontWeight={500}>
              ...
              {`${stakingInfo.rewardRate
                ?.multiply(`${60 * 60 * 24}`)
                ?.toSignificant(4, { groupSeparator: ',' })} BNB / day`}
            </TYPE.black>
          </BottomSection>
        </>
      )}
