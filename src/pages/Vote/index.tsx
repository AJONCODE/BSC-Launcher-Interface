...
import { JSBI, TokenAmount, ChainId } from 'bsc-testnet-dex-sdk'
...
const VoteCard = styled(DataCard)`
  background: radial-gradient(76.02% 75.41% at 1.84% 0%, #f0960e 0%, #000000 100%);
  overflow: hidden;
`
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>BNB Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total BNB supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
