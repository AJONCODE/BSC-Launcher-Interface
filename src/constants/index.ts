import { ChainId, JSBI, Percent, Token, WETH, Fraction } from 'bsc-testnet-dex-sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

import { injected } from '../connectors'

export const ROUTER_ADDRESS = '0x46025Ec640D6b9330673029822638ED89194dc0A'; 
...
export const CryptoDakuOfficial = new Token(ChainId.HARMONY_TESTNET, '0x61c41f78a2F13c325fC023086B285d0b7c354E52', 18, 'CryptoDaku', 'CryptoDakuOfficial')
//export const BNB = new Token(ChainId.HARMONY_TESTNET, '0x61c41f78a2F13c325fC023086B285d0b7c354E52', 18, 'BNB', 'BNB')
...
export const BNB = WETH[ChainId.HARMONY_TESTNET];
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.HARMONY_TESTNET]: [[BNB,CryptoDakuOfficial]]
}
